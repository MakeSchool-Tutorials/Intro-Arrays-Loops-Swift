...
/*:
 ...
 - callout(試してみよう): _添え字_を使うと、配列から要素を取り出すだけではなく、要素を定義することができます。これまでに学んだ定義の方法ととても似ています。下のコードを実際にコーディングエリアに書いてみましょう。
 ...
 */
/*:
 - callout(試してみよう): `palette.count`はpaletteがいくつの要素を持っているかを教えてくれるものでした。5 の代わりにこれを使いましょう。そして添え字を使って、indexと同じ位置番号の要素が 👾 に書き換わるようにしましょう。
