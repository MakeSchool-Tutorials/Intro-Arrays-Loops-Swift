/*:
 ...
 次に、2次元のグリッドを作るにはどうしたらよいでしょう。コンウェイのライフゲームを作るには必須ですね！
...
/*:
 ...
 - experiment:（実験）このやり方を使って、`Character`を自由にグリッドに配置してみましょう。
 
 -
*/
/*:
 - important:（重要）grid[0][0]は左下のセルを表します。
...
//: - important:（重要）配列の位置番号は0から始まるのを忘れないようにしましょう。
